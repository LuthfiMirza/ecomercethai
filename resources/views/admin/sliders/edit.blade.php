...
@section('header', __('admin.sliders.form.edit_title'))
...
<div class="rounded-3xl border border-slate-200 bg-white/80 p-6 shadow-xl shadow-slate-900/5 backdrop-blur dark:border-slate-800 dark:bg-slate-900/50">
    <form action="{{ localized_route('admin.sliders.update', ['slider' => $slider]) }}" method="POST" enctype="multipart/form-data" class="space-y-8">
        @csrf
        @method('PUT')
