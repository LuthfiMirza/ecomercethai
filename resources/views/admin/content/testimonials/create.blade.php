    ...
    <div class="mx-auto max-w-screen-2xl p-4 md:p-6 2xl:p-10">
        <div class="flex flex-col gap-7.5 sm:flex-row sm:items-center sm:justify-between">
            <div>
                ...
                <p class="text-sm font-medium">Create a new customer testimonial</p>
            </div>
            ...
            <form action="#">
                <div class="p-6.5">
                    <div class="mb-4.5">
                        ...
                        <input type="text" placeholder="Enter customer name" class="w-full rounded border-[1.5px] border-stroke bg-transparent py-3 px-5 font-medium outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary">
                    </div>
                    ...
                    <div class="mb-4.5">
                        ...
                        <textarea rows="5" placeholder="Enter customer testimonial" class="w-full rounded border-[1.5px] border-stroke bg-transparent py-3 px-5 font-medium outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary"></textarea>
                    </div>
                    ...
                    <div class="mb-4.5">
                        ...
                        <div class="flex items-center">
                            <div class="flex">
                                <svg class="rating-star fill-gray-300 hover:fill-warning dark:fill-gray-600 dark:hover:fill-warning cursor-pointer" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" data-rating="1">
                                    <path d="M12 17.25L5.25 21L7.05 13.95L1.5 9L8.25 8.25L12 1.5L15.75 8.25L22.5 9L16.95 13.95L18.75 21L12 17.25Z" fill=""></path>
                                </svg>
                                <svg class="rating-star fill-gray-300 hover:fill-warning dark:fill-gray-600 dark:hover:fill-warning cursor-pointer" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" data-rating="2">
                                    <path d="M12 17.25L5.25 21L7.05 13.95L1.5 9L8.25 8.25L12 1.5L15.75 8.25L22.5 9L16.95 13.95L18.75 21L12 17.25Z" fill=""></path>
                                </svg>
                                <svg class="rating-star fill-gray-300 hover:fill-warning dark:fill-gray-600 dark:hover:fill-warning cursor-pointer" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" data-rating="3">
                                    <path d="M12 17.25L5.25 21L7.05 13.95L1.5 9L8.25 8.25L12 1.5L15.75 8.25L22.5 9L16.95 13.95L18.75 21L12 17.25Z" fill=""></path>
                                </svg>
                                <svg class="rating-star fill-gray-300 hover:fill-warning dark:fill-gray-600 dark:hover:fill-warning cursor-pointer" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" data-rating="4">
                                    <path d="M12 17.25L5.25 21L7.05 13.95L1.5 9L8.25 8.25L12 1.5L15.75 8.25L22.5 9L16.95 13.95L18.75 21L12 17.25Z" fill=""></path>
                                </svg>
                                <svg class="rating-star fill-gray-300 hover:fill-warning dark:fill-gray-600 dark:hover:fill-warning cursor-pointer" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" data-rating="5">
                                    <path d="M12 17.25L5.25 21L7.05 13.95L1.5 9L8.25 8.25L12 1.5L15.75 8.25L22.5 9L16.95 13.95L18.75 21L12 17.25Z" fill=""></path>
                                </svg>
                            </div>
                            <input type="hidden" id="rating" name="rating" value="0">
                            <span class="ml-3 text-sm font-medium text-black dark:text-white" id="rating-value">0 stars</span>
                        </div>
                    </div>
        ...
        stars.forEach(star => {
            star.addEventListener('click', function() {
                ...
                stars.forEach((s, index) => {
                    if (index < rating) {
                        s.classList.remove('fill-gray-300', 'dark:fill-gray-600');
                        s.classList.add('fill-warning');
                    } else {
                        s.classList.remove('fill-warning');
                        s.classList.add('fill-gray-300', 'dark:fill-gray-600');
                    }
                });
            });
