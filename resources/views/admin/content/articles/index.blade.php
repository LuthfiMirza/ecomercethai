    ...
    <div class="mx-auto max-w-screen-2xl p-4 md:p-6 2xl:p-10">
        <div class="flex flex-col gap-7.5 sm:flex-row sm:items-center sm:justify-between">
            <div>
                ...
                <p class="text-sm font-medium">Manage blog articles</p>
            </div>
            <a href="{{ route('admin.content.articles.create') }}" class="flex items-center gap-2 rounded bg-primary py-2 px-4.5 font-medium text-white hover:bg-opacity-90">
                ...
                <div class="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
                    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 p-6">
                        ...
                        <div class="flex flex-col sm:flex-row sm:items-center gap-3">
                            <div class="relative">
                                <input type="text" placeholder="Search articles..." class="w-full rounded border border-stroke bg-gray-50 py-2 pl-10 pr-4 text-black focus:border-primary focus-visible:outline-none dark:border-strokedark dark:bg-meta-4 dark:text-white dark:focus:border-primary">
                    ...
                    <div class="flex flex-col">
                        <div class="grid grid-cols-12 rounded-sm bg-gray-2 dark:bg-meta-4">
                            <div class="col-span-5 p-2.5 xl:p-5">
                                <h5 class="text-sm font-medium uppercase xsm:text-xs">Title</h5>
                            </div>
                            <div class="col-span-3 p-2.5 xl:p-5">
                                <h5 class="text-sm font-medium uppercase xsm:text-xs">Author</h5>
                            </div>
                        ...
                        <div class="grid grid-cols-12 border-t border-stroke dark:border-strokedark">
                            <div class="col-span-5 p-2.5 xl:p-5">
                                <p class="font-medium text-black dark:text-white">How to Choose the Best Gaming Keyboard</p>
                                <p class="text-sm text-gray-500 dark:text-gray-400">Published on 2025-09-10</p>
                            </div>
                            <div class="col-span-3 p-2.5 xl:p-5">
                                <p class="font-medium text-black dark:text-white">Admin User</p>
                            </div>
                            <div class="col-span-2 p-2.5 xl:p-5">
                            ...
                            <div class="col-span-2 p-2.5 xl:p-5">
                                <div class="flex items-center space-x-3.5">
                                    <a href="{{ route('admin.content.articles.edit', 1) }}" class="hover:text-primary">
                        ...
                        <div class="grid grid-cols-12 border-t border-stroke dark:border-strokedark">
                            <div class="col-span-5 p-2.5 xl:p-5">
                                <p class="font-medium text-black dark:text-white">Top 5 Gaming Mice for 2025</p>
                                <p class="text-sm text-gray-500 dark:text-gray-400">Last updated 2025-09-05</p>
                            </div>
                            <div class="col-span-3 p-2.5 xl:p-5">
                                <p class="font-medium text-black dark:text-white">Admin User</p>
                            </div>
                            ...
                            <div class="col-span-2 p-2.5 xl:p-5">
                                <div class="flex items-center space-x-3.5">
                                    <a href="{{ route('admin.content.articles.edit', 2) }}" class="hover:text-primary">
                                        <svg class="fill-current" width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M8.55005 2.25H4.05005C2.7788 2.25 1.75505 3.29625 1.75505 4.5675L1.75505 13.5675C1.75505 14.8388 2.7788 15.885 4.05005 15.885H13.05C14.3213 15.885 15.3675 14.8388 15.3675 13.5675V9M11.475 1.5H16.5V6.525M3.375 14.625L11.25 6.75L15.75 11.25L7.875 15.75L3.375 15.75V14.625Z" stroke="" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                                        </svg>
                                    </a>
