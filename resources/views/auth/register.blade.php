            ...
            <div class="p-8 sm:p-10 lg:p-12">
                ...
                <div class="space-y-8">
                    ...
                    <div class="flex items-center justify-center gap-4">
                        <button type="button" class="h-12 w-12 rounded-full border border-[#ffd7de] bg-white shadow-sm text-[#ea4335] hover:border-[#ffb4c1]" aria-label="Continue with Google">
                            <i class="fa-brands fa-google text-lg"></i>
                        </button>
                        <button type="button" class="h-12 w-12 rounded-full border border-[#ffd7de] bg-white shadow-sm text-[#1877f2] hover:border-[#ffb4c1]" aria-label="Continue with Facebook">
                            <i class="fa-brands fa-facebook-f text-lg"></i>
                        </button>
                        <button type="button" class="h-12 w-12 rounded-full border border-[#ffd7de] bg-white shadow-sm text-neutral-900 hover:border-[#ffb4c1]" aria-label="Continue with Apple">
