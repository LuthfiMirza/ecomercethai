    ...
    <div class="grid md:grid-cols-[1.05fr_1fr]">
        <div class="hidden md:flex flex-col justify-between bg-gradient-to-b from-[#fff4ec] via-[#ffe8d8] to-[#ffe1c7] p-10 lg:p-12">
            <div class="flex items-center justify-between text-sm font-semibold text-orange-500">
                ...
                <span class="inline-flex h-9 items-center rounded-full bg-white/80 px-4 text-orange-500" data-i18n="register.badge">New here?</span>
            </div>
            ...
            <ul class="mt-6 flex flex-col gap-2 text-sm text-orange-500/80">
                <li class="inline-flex items-center gap-3"><span class="h-1.5 w-1.5 rounded-full bg-orange-400"></span><span data-i18n="register.highlights.reward">Get exclusive promotions and launch alerts.</span></li>
                <li class="inline-flex items-center gap-3"><span class="h-1.5 w-1.5 rounded-full bg-orange-400"></span><span data-i18n="register.highlights.wishlist">Keep wishlist items synced everywhere.</span></li>
                <li class="inline-flex items-center gap-3"><span class="h-1.5 w-1.5 rounded-full bg-orange-400"></span><span data-i18n="register.highlights.checkout">Check out quickly with saved details.</span></li>
            </ul>
        </div>
        ...
        <div class="relative bg-white">
            ...
            <div class="p-8 sm:p-10 lg:p-12">
                ...
                <div class="mb-8 space-y-3 text-center md:text-left">
                    <h1 class="text-3xl font-semibold text-neutral-900" data-i18n="register.heading">Create your account</h1>
                    <p class="text-base text-neutral-600" data-i18n="register.subtitle">Join our community and unlock member-only deals.</p>
                </div>
                ...
                <div class="space-y-8">
                    ...
                    <div class="relative text-center text-sm text-neutral-500 before:absolute before:left-0 before:top-1/2 before:h-px before:w-full before:bg-neutral-200 before:content-['']">
                        <span class="relative bg-white px-3" data-i18n="register.social_divider">Or sign up with</span>
                    </div>
                    ...
                    <p class="text-sm text-center text-neutral-500">
                        ...
                        <a href="{{ route('login') }}" class="font-semibold text-orange-500 hover:text-orange-400" data-i18n="register.have_account_cta">Sign in</a>
                    </p>
                </div>
            </div>
        </div>
