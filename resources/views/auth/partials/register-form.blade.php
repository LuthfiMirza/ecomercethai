<form method="POST" action="{{ route('register') }}" class="space-y-6">
    ...
    <button type="submit" class="w-full rounded-xl bg-gradient-to-r from-[#ff9f68] to-[#ff7043] py-3 font-semibold text-white shadow-[0_20px_40px_-18px_rgba(255,112,67,0.8)] transition hover:opacity-90" data-i18n="register.submit">Sign up</button>
</form>
